...
export default function Home() {
  return (
    <div className="bg-black">
      ...
      {/* Floating Book a Ticket Button for Mobile */}
      <Link href="/tickets" className="fixed bottom-4 right-4 z-50 md:hidden" aria-label="Book a Ticket">
        <Button className="bg-ted-red text-white shadow-lg rounded-sm px-6 py-6 text-lg font-bold flex items-center gap-2">
