...
export default function TooltipButton({
  ...
  return (
    <div
      ...
      className={cn(
        "relative min-w-[160px] h-10 bg-ted-red text-white rounded text-center transition-all duration-300 overflow-hidden group cursor-pointer",
        className
      )}
    >
      {/* Tooltip text */}
      ...
      {/* Hover slide-up text */}
      <div className="absolute inset-0 flex items-center justify-center transition-all duration-500 translate-y-full group-hover:translate-y-0">
        <Link
      href="/tickets"
